...
import com.assorted.poker.engine.HoldEmSimulationEngine;
import com.assorted.poker.gui.HoldEmAnalyzerFrame;
import com.assorted.poker.gui.JSplashScreen;
import com.assorted.poker.gui.JTrialExpiredScreen;
...
public class HoldEmAnalyzerApplication
{
	...
	public static void main(String[] args)
	{
		...
		// display the GUI:
		// =====================================================================
		if ((continueExecution == true) && (arguments.size() == 0))
		{
			// =====================================================================
	...
	public void processArguments(ArrayList arguments)
	{
		...
		else
		{
			...
			while (arguments.size() > 0)
			{
				...
				if (nextArgument.equals("-bh") == true)
				{
				...
				// ------------------------------------------------------
				if (nextArgument.equals("-text") == true)
				{
				...
				// reflect that in the variables:
				// ------------------------------------------------------
				if (nextArgument.equals("-tabdelim") == true)
				{
				...
				// reflect that in the variables:
				// ------------------------------------------------------
				if (nextArgument.equals("-tabdelimheader") == true)
				{
				...
				// ------------------------------------------------------
				if (nextArgument.equals("-ash") == true)
				{
				...
				if (nextArgument.equals("-hc") == true)
				{
				...
				if (nextArgument.equals("-bc") == true)
				{
					arguments.remove(0);
				...
				if (nextArgument.equals("-pc") == true)
				{
					// Determine if there are 2 arguments to process, the
		...
		// --------------------------------------------------------------
		if (simulateAllStartingHands == true)
		{
			...
			boolean tabDelimitedOutputHeader)
	{
		...
		// --------------------------------------------------------------
		if (tabDelimitedOutput == true)
		{
			if (tabDelimitedOutputHeader == true)
			{
			...
			boolean tabDelimitedOutputHeader)
	{
		...
		for (int i = 2; i <= Card.RANK_ACE; i++)
		{
			...
			if (tabDelimitedOutput == true)
			{
				System.out.println(hole1.toString() + hole2.toString() + ":\t"
